...
def classify_object(yolo, image):
    """
    ...
    prediction, new_image = yolo.detect_image(image, False)
...
def draw_annotated_box(image, box_list_list, label_list, color_list):
    ...
    font_path = os.path.join(
        os.path.dirname(__file__), "src/keras_yolo3/font/FiraMono-Medium.otf"
    )
